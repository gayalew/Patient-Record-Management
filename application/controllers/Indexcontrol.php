...
public function get_dashboard_data() {
  ...
  // Retrieve data
  $data['get_all_patient'] = $this->Dashboard_model->get_all_patient();
  $data['get_all_user'] = $this->Dashboard_model->get_all_user();
  $data['get_all_doctor'] = $this->Dashboard_model->get_all_doctor();
